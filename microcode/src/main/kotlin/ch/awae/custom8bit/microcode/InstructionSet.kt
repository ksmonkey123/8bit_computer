...
val INSTRUCTION_SET: Set<Operation> = setOf(
    ...
    Operation(0x74, "LOAD A (CD)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_A, ADR_REG_CD)),
    Operation(0x75, "LOAD B (CD)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_B, ADR_REG_CD)),
    Operation(0x76, "LOAD C (CD)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_C, ADR_REG_CD)),
    Operation(0x77, "LOAD D (CD)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_D, ADR_REG_CD)),
    // 0x68:6b
    ...
    Operation(0x80, "STORE A (L)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_A, ADR_LITERAL)),
    Operation(0x81, "STORE B (L)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_B, ADR_LITERAL)),
    Operation(0x82, "STORE C (L)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_C, ADR_LITERAL)),
    Operation(0x83, "STORE D (L)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_D, ADR_LITERAL)),
    Operation(0x84, "STORE A (CD)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_A, ADR_REG_CD)),
    Operation(0x85, "STORE B (CD)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_B, ADR_REG_CD)),
    Operation(0x86, "STORE C (CD)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_C, ADR_REG_CD)),
    Operation(0x87, "STORE D (CD)", 2, step0 = MicroOp(READ_MEMORY, WRITE_REG_D, ADR_REG_CD)),
