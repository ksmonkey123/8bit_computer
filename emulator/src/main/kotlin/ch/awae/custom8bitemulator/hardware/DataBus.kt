 ...
 */
class DataBus(private val pullHigh: Boolean) : SimulationElement(ElementType.WIRE) {
    private val idleState = if (pullHigh) 0xffffffffu else 0x00000000u

    private val drivers = mutableMapOf<Driver, UInt>()

    var state: UInt = idleState
        private set
    var contention: UInt = 0x00000000u
        private set
