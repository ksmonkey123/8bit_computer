 ...
 */
class DataSignal(private val pullHigh: Boolean) : SimulationElement(ElementType.WIRE), SignalWire {
    ...
    private inner class DriverImpl : Driver {
        override fun set(value: Boolean) {
            this@DataSignal.drive(this, value)
        }

        override fun release() {
            this@DataSignal.release(this)
        }
    }
}
